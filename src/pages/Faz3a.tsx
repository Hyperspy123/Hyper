              ...
              return (
                <div key={post.id} className="bg-[#0a0f3c]/40 border border-white/10 rounded-[40px] p-7 space-y-5 backdrop-blur-2xl relative overflow-hidden group shadow-xl transition-all">
                  ...
                  <div className="flex items-center gap-4 text-right">
                    ...
                    <div className="text-right">
                      <h4 className="font-black text-lg text-white leading-none">{post.profiles?.first_name}</h4>
                  ...
                  <div className="bg-white/5 p-4 rounded-2xl border border-white/5 space-y-2">
                    ...
                    <div className="w-full h-1.5 bg-white/10 rounded-full overflow-hidden">
                      <div className="h-full bg-cyan-500 transition-all duration-1000 shadow-[0_0_10px_rgba(34,211,238,0.5)]" style={{ width: `${(count / post.missing_players) * 100}%` }} />
                    </div>
                  </div>
                  {!isFull && (
