...
export default function Header() {
  ...
  return (
    <>
      {/* تعديل الـ Header ليكون Fixed: 
          - زدت الـ z-[110] لضمان الظهور فوق كل شيء
          - أضفت bg-opacity مع backdrop-blur لتأثير النيون الفخم
      */}
      <header 
        className="fixed top-0 left-0 right-0 z-[110] flex items-center justify-between bg-[#0a0f3c]/70 border-b border-white/5 px-6 h-20 backdrop-blur-xl"
        dir="rtl"
      >
        {/* اليمين: اللوغو */}
        <div 
        ...
        >
          ...
          <h1 className="text-2xl font-[1000] italic tracking-tighter text-white uppercase">
        ...
        <div className="flex items-center gap-2" dir="ltr">
          <button 
            ...
            className="relative p-2.5 bg-white/5 rounded-xl border border-white/10 text-cyan-400 transition-all active:scale-90"
          >
            <Bell size={22} />
            {unreadCount > 0 && (
          ...
          {user ? (
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-[10px] font-black transition-all active:scale-95"
            >
              <LogOut size={14} />
            ...
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-cyan-500 text-[#0a0f3c] text-[10px] font-black shadow-lg shadow-cyan-500/20 active:scale-95"
            >
              <LogIn size={14} />
          ...
          <div className="relative">
            ...
            <div 
              className={`absolute top-14 left-0 w-[240px] bg-[#14224d]/95 backdrop-blur-3xl border border-white/10 rounded-[28px] shadow-2xl transition-all duration-300 z-[120] overflow-hidden ${
                isMenuOpen 
      ...
      {/* مساحة تعويضية (Spacer):
          بما أن الهيدر صار Fixed، نحتاج نضيف div فارغ بنفس طوله (h-20) 
          عشان المحتوى ما يختفي وراه في كل الصفحات.
      */}
